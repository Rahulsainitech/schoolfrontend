...
import swal from "sweetalert2";
  // "proxy": "https://school-app-backend.onrender.com/",

export const registerStudent = (user) => async (dispatch) => {
  dispatch({ type: "USER_REGISTER_REQUEST" });
  try {
    const response=await axios.post("https://school-app-backend.onrender.com/api/student/studentregister",user);
...
export const loginStudent = (user) => async (dispatch) => {
  ...
  try {
    const response = await axios.post("https://school-app-backend.onrender.com/api/student/login", user);
    ...
    window.location.href = "https://school-app-backend.onrender.com/studentprofile/"+response.data._id;
  } catch (error) {
...
export const getAllFaculty = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get("https://school-app-backend.onrender.com/api/faculty/getallusers");
...
export const getAllFacultyImages = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get("https://school-app-backend.onrender.com/api/faculty/getallfacultyimages");
    console.log("all usere",res);
...
export const getAllStudents = () => async (dispatch) => {
  ...
  try {
    const res = await axios.get("https://school-app-backend.onrender.com/api/student/getallstudents");
    console.log("all usere",res);
...
export const deleteUserById = (userId) => async (dispatch) => {
  try {
    await axios.post("https://school-app-backend.onrender.com/api/users/deleteuser", { userId });
...
export const addAdmin = (userid) => async (dispatch) => {
  ...
  try {
    const response = await axios.post("https://school-app-backend.onrender.com/api/faculty/addnewadmin", { userid });
...
export const facultyRegister = (user) => async (dispatch) => {
  ...
  try {
    ...
    const response=await axios.post("https://school-app-backend.onrender.com/api/faculty/facultyregister",user);
...
export const facultyLogin = (user) => async (dispatch) => {
  ...
  try {
    const response = await axios.post("https://school-app-backend.onrender.com/api/faculty/login", user);
