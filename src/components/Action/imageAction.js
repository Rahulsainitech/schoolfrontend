...
export const addNewImage=(picInfo)=> async(dispatch)=>{
    ...
    try {
        const response=await axios.post("/api/gallery/pic",picInfo)
...
export const delImage=(picInfo)=> async(dispatch)=>{
    ...
    try {
        const response=await axios.post("/api/gallery/delimage",picInfo)
...
export const getAllImage=()=> async(dispatch)=>{
    ...
    try {
        const response=await axios.get("/api/gallery/getallpic")
...
export const getSplImage=()=> async(dispatch)=>{
    ...
    try {
        const response=await axios.get("/api/gallery/getsplpic")
