...
export const addNews=(newsInfo)=> async(dispatch)=>{
    ...
    try {
        const response=await axios.post("/api/news&event/news",newsInfo)
...
export const delImage=(newsInfo)=> async(dispatch)=>{
    ...
    try {
        const response=await axios.post("/api/news&event/del",newsInfo)
...
export const getAllNews=()=> async(dispatch)=>{
    ...
    try {
        const response=await axios.get("/api/news&event/getallnews")
